...
public interface IColliniDbContext
{
    Task SaveChanges();
    void RejectChanges();
...
public class ColliniDbContext : DbContext, IColliniDbContext
{
    ...
    {
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(ColliniDbContext).Assembly);
    }

    private void ConfigureQueryFilters(ModelBuilder modelBuilder)
    {
        var entityTypes = modelBuilder.Model.GetEntityTypes();
        var configureQueryFilterMethod = typeof(ColliniDbContext)
