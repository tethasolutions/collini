    ...
    public class JobMappingProfile : Profile
    {
        public JobMappingProfile()
        {
            ...
            CreateMap<Job, JobSearchReadModel>()
                ...
                .MapMember(x => x.LastQuotation, y => y.Quotations.OrderByDescending(z => z.EditedOn).FirstOrDefault().Status)
                .MapMember(x => x.LastQuotationDate, y => y.Quotations.OrderByDescending(z => z.EditedOn).FirstOrDefault().EditedOn)
                .MapMember(x => x.LastOrder, y => y.Orders.OrderByDescending(z => z.EditedOn).FirstOrDefault().Status)
                .MapMember(x => x.LastOrderDate, y => y.Orders.OrderByDescending(z => z.EditedOn).FirstOrDefault().EditedOn)
